...
md`To see your own events, enter them below.`
)}
...
text({title: "Chart title", placeholder: "Title A (placeholder)", value: "Title A "})
)}

function _subtitle(text){return(
text({title: "Chart subtitle", value: "Subtitle A"})
)}
